    ...
    return {
      ...
      link: function($scope, elem, attrs) {
        ...
        $scope.showSum = function(data, col) {
          var item, output, prop, sum, val, _i, _len;
